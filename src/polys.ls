...
module.exports = (polys) ->
  ...
  polys.polyexpand = polyexpand = (a,b) ->
  ...
  # ax^2 + bx + c
  polys.p_quadratic = p_quadratic = (a,b,c) ->
    p = new poly(2)
    p.set(c,b,a)
    return p

  # ax + b
  polys.p_linear = p_linear = (a,b) ->
    p = new poly(1)
    p.set(b,a)
    return p

  # a
  polys.p_const = p_const = (a) ->
    p = new poly(0)
    p.set(a)
    return p
